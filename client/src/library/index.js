...
export default function Library() {
  ...
  const { playlists, setPlaylists, customPlaylists, setCustomPlaylists } =
  ...
  const comparePlaylists = (a, b) =>
    a.favourite && b.favourite ? 0 : a.favourite ? -1 : 0;
