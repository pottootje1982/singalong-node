...
var spotifyApi = new SpotifyApi('http://localhost:1337', {
  refreshToken: refreshToken,
})

describe('Spotify API', async () => {
  it('Get playlists', async () => {
    var data = await spotifyApi.api.getUserPlaylists()
    console.log('Retrieved playlists', data.body)
  })

  it('Search artist', (done) => {
    spotifyApi
      .api.getArtist('2hazSY4Ef3aB9ATXW7F5w3')
      .then(
        (data) => {
  ...
  var album = {
    body: {
      ...
      images: [
        {
          height: 634,
          url:
            'https://i.scdn.co/image/ee6d0d264005b0549be5fa76d0cf6e57d0a542ce',
          width: 640,
        },
        {
          height: 297,
          url:
            'https://i.scdn.co/image/78ace3900b14d836c3d45603872dd63300cb89f5',
          width: 300,
        },
        {
          height: 63,
          url:
            'https://i.scdn.co/image/83c7a03dbd942196f4d80a5e976294fba66c8356',
          width: 64,
        },
      ],
      ...
      tracks: {
        href:
          'https://api.spotify.com/v1/albums/1NF8WUbdC632SIwixiWrLh/tracks?offset=0&limit=50',
        items: [
          {
            artists: [
              {
                external_urls: {
                  spotify:
                    'https://open.spotify.com/artist/0WwSkZ7LtFUFjGjMZBMt6T',
                },
                href:
                  'https://api.spotify.com/v1/artists/0WwSkZ7LtFUFjGjMZBMt6T',
                id: '0WwSkZ7LtFUFjGjMZBMt6T',
                name: 'Dire Straits',
                type: 'artist',
                uri: 'spotify:artist:0WwSkZ7LtFUFjGjMZBMt6T',
            ...
            explicit: false,
            external_urls: {
              spotify: 'https://open.spotify.com/track/0h8pmQEibj5GUdMoaqrJnF',
            },
          ...
          },
          {
            ...
            explicit: false,
            external_urls: {
              spotify: 'https://open.spotify.com/track/4tyl9OMKMG8F2L0RUYQMH3',
            },
          ...
          },
          {
            ...
            explicit: false,
            external_urls: {
              spotify: 'https://open.spotify.com/track/6rg61PBHTfEDvgNt7MNhyU',
            },
          ...
          },
          {
            ...
            explicit: false,
            external_urls: {
              spotify: 'https://open.spotify.com/track/0NL5lqKSd0obXvKwfvyTKw',
            },
          ...
          },
          {
            ...
            explicit: false,
            external_urls: {
              spotify: 'https://open.spotify.com/track/232usfwnBVq3HPkhBxKFcT',
            },
          ...
          },
          {
            ...
            explicit: false,
            external_urls: {
              spotify: 'https://open.spotify.com/track/5UvLMW2qdHge1P9AkkDXfa',
            },
          ...
          },
          {
            ...
            explicit: false,
            external_urls: {
              spotify: 'https://open.spotify.com/track/1W3kfKYF1BimzHj1Q20hAF',
            },
          ...
          },
          {
            ...
            explicit: false,
            external_urls: {
              spotify: 'https://open.spotify.com/track/7EmSPZ9f1AiLR9eVHNSI62',
            },
