...
export class GeniusEngine extends LyricsSearchEngine {
  ...
  constructor() {
    super("Genius", {
      domain: "https://www.genius.com",
      searchQuery: "https://genius.com/api/search/multi?per_page=5&q=",
      lyricsLocation: "#lyrics-root",
      convertHtml: true,
    });
  }
  ...
  public async searchLyrics(artist, title) {
    ...
    var songs = results.response.sections.filter(
      (item) => item.type === "song"
    );
